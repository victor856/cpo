...
class PolicyGradientSafeDDPG(BatchPolopt, Serializable):
    ...
    def __init__(
            ...
            ddpg_dual_var=0,
            ddpg_batch_size=128,
            ddpg_min_pool_size=10000,
            ddpg_replay_pool_size=1000000,
        ...
        super(PolicyGradientSafeDDPG, self).__init__(optimizer=optimizer, 
        ...
        # off-policy PDO-DDPG algorithm
        self.pdo_ddpg = PDO_DDPG(
            env=self.env,
            policy=ddpg_policy,
            es=ddpg_es,
            qf=ddpg_qf,
            qf_cost=ddpg_qf_cost,
            dual_var=ddpg_dual_var,
            safety_constraint=safety_constraint,
            batch_size=ddpg_batch_size,
            min_pool_size=ddpg_min_pool_size,
            qf_learning_rate=ddpg_qf_learning_rate,
            qf_cost_learning_rate=ddpg_qf_cost_learning_rate,
            dual_learning_rate=ddpg_dual_learning_rate,
            policy_learning_rate=ddpg_policy_learning_rate,
        ...
        # balance between on-policy and off-policy 
    ...
    def optimize_policy(self, itr, samples_data):
        ...
        if self.learn_safety_tradeoff_coeff:
            ...
            logger.record_tabular('Off-policy Dual', self.pdo_ddpg.avg_dual)  
